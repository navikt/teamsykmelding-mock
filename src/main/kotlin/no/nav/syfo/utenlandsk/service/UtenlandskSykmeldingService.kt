...
class UtenlandskSykmeldingService(
    ...
    suspend fun opprettUtenlanskPdf(
        utenlandskSykmeldingPdfRequest: UtenlandskSykmeldingPdfRequest
    ): String {
        val journalpostId =
        ...
        val opprettOppgave =
            OpprettOppgave(
                ...
                personident = utenlandskSykmeldingPdfRequest.fnr,
            )
    ...
    suspend fun opprettUtenlanskNavNo(
        utenlandskSykmeldingNavNoRequest: UtenlandskSykmeldingNavNoRequest
    ): String {
        val journalpostId =
            dokarkivClient.opprettJournalpost(
