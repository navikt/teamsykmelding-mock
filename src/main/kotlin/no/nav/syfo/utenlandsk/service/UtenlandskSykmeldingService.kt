...
class UtenlandskSykmeldingService(
    ...
    suspend fun opprettUtenlanskPdf(utenlandskSykmeldingRequest: UtenlandskSykmeldingRequest): String {
    ...
    suspend fun opprettUtenlanskNavNo(utenlandskSykmeldingNavNoRequest: UtenlandskSykmeldingNavNoRequest): String {
        val journalpostId = dokarkivClient.opprettJournalpost(
