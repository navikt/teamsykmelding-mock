...
data class PapirsykmeldingCreatedResponse(
...
class PapirsykmeldingService(
    ...
    suspend fun opprettPapirsykmelding(
        papirsykmeldingRequest: PapirsykmeldingRequest
    ): PapirsykmeldingCreatedResponse {
        val ocr =
        ...
        return PapirsykmeldingCreatedResponse(
            journalpostId,
            automatic = !papirsykmeldingRequest.utenOcr
        )
    }
