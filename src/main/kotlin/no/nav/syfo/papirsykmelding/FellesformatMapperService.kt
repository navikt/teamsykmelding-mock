    ...
    return HelseOpplysningerArbeidsuforhet.MedisinskVurdering().apply {
        if (!medisinskVurderingType.hovedDiagnose.isNullOrEmpty()) {
            hovedDiagnose = HelseOpplysningerArbeidsuforhet.MedisinskVurdering.HovedDiagnose().apply {
                diagnosekode = toMedisinskVurderingDiagnose(medisinskVurderingType.hovedDiagnose[0].diagnosekode, medisinskVurderingType.hovedDiagnose[0].diagnosekodeSystem, medisinskVurderingType.hovedDiagnose[0].diagnose)
            }
        }
...
fun toMedisinskVurderingDiagnose(originalDiagnosekode: String, originalSystem: String?, diagnose: String?): CV {
